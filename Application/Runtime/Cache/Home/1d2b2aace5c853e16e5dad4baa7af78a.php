...
<html lang="en">
    ...
    <head>
        ...
        <link href="/shop3.2/Public/Home/css/goods/fruit_list.css" rel="stylesheet" type="text/css">
...
<div class="good_fruit">
    ...
    <div class="good_fruit_label">
        <div class="good_fruit_png"><img src="/shop3.2/Public/Home/img/fruit.png"></div>
    </div>
    <!--显示水果图片区域-->
